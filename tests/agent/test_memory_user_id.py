...
# NOTE: TestMem0UserIdScoping and TestHonchoUserIdScoping were removed in
# the programmer-focus trim refactor — those memory plugins are no longer
# bundled. The generic memory-manager user-id threading tests above and the
# AIAgent propagation tests below still cover the cross-cutting behavior.
